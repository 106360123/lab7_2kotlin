package com.example.weight_kotlin
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_bmi = findViewById(R.id.tv_bm1)
        tv_progress = findViewById(R.id.tv_progress)
        ll_progress = findViewById(R.id.ll_progress)
        progressBar2 = findViewById(R.id.progressBar2)
        findViewById<Button1>(R.id.btn_calculate).setOnClickListener(View.OnClickListener {
    ...
    private fun runAsyncTask() {
        object : AsyncTask<Void, Int, Boolean>() {
            ...
            protected override fun onProgressUpdate(vararg values: Int?) {
                ...
                progressBar2!!.progress = values[0]!!.toInt()
